  ...
  return (
    <div className="wrap">
        ...
        {USERS.map((u) => (
          ...
          >
            <div
              ...
              style={{
                background: u.color,
                opacity: u.id === selectedUser ? 1 : 0.4,
              }}
            />
            {u.id}
          </div>
      ...
      <div className="tutorial-box">
        <p>
          Börja med att klicka på ditt namn, sedan klicka en gång på dagarna du
          kan och två gånger på de du inte kan.
        </p>
      </div>

      {Object.values(months).map((m) => {
        let dow = m.days[0].getDay();
        dow = (dow + 6) % 7;
                ...
                return (
                  <div
                    ...
                    className={
                      "cell" +
                      (isToday ? " today" : "") +
                      (isFullSquad(data, key) ? " full-squad" : "")
                    }
                    style={{
                      background:
                        mySt === "available"
                          ...
                          return (
                            <div key={u.id} className="mobile-user">
                              ...
                              <span
                                ...
                                style={{
                                  color:
                                    st === "available" ? u.color : undefined,
                                }}
                              >
                                {u.id}
                              </span>
      ...
      <a className="gino-shoutout" target="_blank" href="https://ginogracia.se">
        Gino Gracia Baumkircher @2026
      </a>
      <Image
        src="/funnybebe.jpg"
        alt="CS2"
